(function () {
  ...
  G.renderCurrentPage = function () {
    ...
    root.innerHTML = [
      ...
      '<div class="hero__actions"><a class="button button--primary" href="', G.pageUrl("bestiario.html"), '">Explorar el Bestiario</a>',
      '<a class="button" href="', G.pageUrl("mundos.html"), '">Conocer los siete mundos</a>',
      '<a class="button" href="', G.pageUrl("recta-provincia.html"), '">Abrir el expediente de la Recta Provincia</a></div>',
      ...
      '<div class="door-grid"><article class="door-card door-card--primary"><span class="door-card__index">01</span><h3>Bestiario del Archipiélago</h3><p>24 fichas con búsqueda, filtros, vista rápida y URL propia.</p><a class="button button--primary" href="', G.pageUrl("bestiario.html"), '">Explorar el Bestiario</a></article>',
      '<article class="door-card"><span class="door-card__index">02</span><h3>Los siete mundos</h3><p>Contextos abiertos de consulta. Su orden es editorial y nunca bloquea información.</p><a class="button" href="', G.pageUrl("mundos.html"), '">Conocer los siete mundos</a></article>',
      '<article class="door-card"><span class="door-card__index">03</span><h3>Recta Provincia</h3><p>Exposición especial que distingue historia documentada, tradición legendaria y cultura posterior.</p><a class="button" href="', G.pageUrl("recta-provincia.html"), '">Abrir el expediente</a></article></div></section>',
