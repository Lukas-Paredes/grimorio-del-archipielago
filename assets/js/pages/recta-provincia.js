(function () {
  ...
  G.renderCurrentPage = function () {
    ...
    root.innerHTML = [
      ...
      '<p>Tribunales, jerarquías, jurisdicciones, mensajería, custodia y poder secreto pertenecen aquí al registro legendario. La plataforma no los presenta automáticamente como estructura histórica comprobada.</p>',
      ...
      '<p>Literatura, divulgación e imágenes contemporáneas reinterpretan la Recta Provincia. El diseño de expediente de esta plataforma pertenece a esa capa de recreación y no simula un documento histórico.</p>',
