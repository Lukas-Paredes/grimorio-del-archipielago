(function () {
  ...
  G.renderCurrentPage = function () {
    ...
    root.innerHTML = [
      ...
      G.seal(world.status), '<div class="actions"><a class="button" href="', G.pageUrl("bestiario.html", "?world=" + encodeURIComponent(world.id)), '">Consultar figuras de este mundo</a>',
      world.id === "recta" ? '<a class="button button--quiet" href="' + G.pageUrl("recta-provincia.html") + '">Abrir expediente especial</a>' : "", '</div></div>',
      ...
      '<section class="world-context-grid"><article><h2>Ambientes</h2>', G.renderList(world.environments), '</article><article><h2>Señales</h2>', G.renderList(world.signals), '</article><article><h2>Clave de lectura</h2><p>', G.escape(world.idea), '</p></article></section>',
