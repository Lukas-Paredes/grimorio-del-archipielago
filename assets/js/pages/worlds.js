(function () {
  ...
  G.renderCurrentPage = function () {
    ...
    root.innerHTML = [
      ...
      '<section class="section split-panel"><div><h2>Ver relaciones entre mundos</h2><p>La continuidad narrativa pertenece al proyecto y se distingue de parentescos, oposiciones y asociaciones legendarias.</p><a class="text-link" href="cosmologia.html">Abrir Cosmología</a></div>',
      '<div><h2>Buscar por mundo</h2><p>El Bestiario puede abrirse filtrado sin bloquear las demás fichas.</p><a class="text-link" href="bestiario.html">Abrir el Bestiario</a></div></section>'
    ].join("");
  };
}());
