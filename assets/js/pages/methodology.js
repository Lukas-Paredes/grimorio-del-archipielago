(function () {
  ...
  G.renderCurrentPage = function () {
    ...
    root.innerHTML = [
      '<section class="page-hero methodology-hero"><span class="chapter-index">Puerta V · Trazabilidad</span><span class="eyebrow">Fuentes, estados y criterios</span><h1>Cómo se construye este archivo</h1>',
      '<p class="lead">El Grimorio distingue entre tradición documentada, variantes locales, interpretación curatorial y recreación visual. Esta página hace visibles las fuentes disponibles, los límites de la versión actual y la investigación pendiente.</p>',
      '<div class="archive-definition"><strong>Un archivo abierto, no un relato cerrado</strong><p>El objetivo es favorecer la difusión cultural y la consulta pública sin inventar datos, fijar una versión única ni atribuir validaciones que no están registradas.</p></div></section>',
      ...
      '<div>',
      '<section id="proposito" class="method-section"><span class="eyebrow">Propósito y alcance</span><h2>Un archivo digital para difusión cultural</h2>',
      '<p>El proyecto organiza 24 fichas existentes para facilitar consulta pública, mediación cultural, comparación y trazabilidad. Su alcance se concentra en el Archipiélago de Chiloé, pero algunas entradas poseen circulación regional aún no delimitada.</p>',
      ...
      '<div>', G.seal("interpretation"), '<p>Decisión curatorial o relacional del proyecto.</p></div>',
